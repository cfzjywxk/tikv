...
use tracker::{get_tls_tracker_token, set_tls_tracker_token, TrackerToken, GLOBAL_TRACKERS, TrackGuard};
...
impl<E: Engine, L: LockManager> TxnScheduler<E, L> {
    ...
    async fn process_write(self, snapshot: E::Snap, task: Task, statistics: &mut Statistics) {
        ...
        let mut total_throttle_duration = TrackGuard::new(tracker, |m| &mut m.scheduler_throttle_nanos);
